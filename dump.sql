...
-- Listage des données de la table techbase.fiches : ~10 rows (environ)
DELETE FROM `fiches`;
...
INSERT INTO `fiches` (`id`, `rubrique_id`, `titre`, `etat`, `description`, `priorite`, `created_at`, `updated_at`) VALUES
	...
	(8, NULL, 'Diagnostic panne serveur ESXi', 'En cours', 'Procédure de diagnostic pour serveur ESXi en panne. Étapes de vérification hardware et logs.', 'Important', '2025-10-11 20:32:17', '2025-10-12 09:11:12'),
	...
	(10, NULL, 'Inventaire des postes de travail', 'En cours', 'Liste des postes de travail avec specs, dates d\'achat, responsables. \r\n> À compléter avec les nouveaux arrivants.', 'Standard', '2025-10-11 20:32:17', '2025-10-12 08:43:54'),
...
-- Listage des données de la table techbase.fiche_tag : ~17 rows (environ)
DELETE FROM `fiche_tag`;
...
-- Listage des données de la table techbase.rubriques : ~7 rows (environ)
